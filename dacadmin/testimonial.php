      ...
      <form  name="form1" method="post" action="" enctype="multipart/form-data" class="AdvancedForm">
        <table width="100%" cellpadding="0" cellspacing="0" border="0" class="FormTbl">
          ...
          <tr class="TitleBarB">
            ...
            <td><input type="text" name="date" id="date" value="<?php echo stripslashes($rasTest['date']);?>" class="inputBox" /></td>
          </tr>
          <tr class="TitleBarB">
            <td><strong>Content:</strong></td>
            <td><textarea name="contents" cols="" rows="10" style="width:50%"><?php echo stripslashes($rasTest['contents']);?></textarea>
              <?php /*?><?php
          ...
          <tr class="TitleBarB">
            ...
            <td><?php if(isset($rasTest['filename']) && !empty($rasTest['filename'])){?><img src="../img/testimonial/<?php echo $rasTest['filename'];?>" width="120" /><br /><?php }?><input type="file" class="inputBox" name="filename" /> <strong>Note:</strong>Image Size should be in the ratio of 300px X 224px.</td></td	>
          </tr>
