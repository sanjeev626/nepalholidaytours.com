...
?>
  ...
  <tr class="TitleBar">
    ...
    <tr>
      ...
      <td class="TitleBarA" align="center"><a href="<?php echo ADMINURLPATH; ?>pagesUpdate&pid=<?php echo $rasProduct['id'];?>"><img src="images/action_edit.gif" alt="Edit" width="24" height="24" title="Edit"></a></td>
    </tr>
    <?php
    }
    ?>
