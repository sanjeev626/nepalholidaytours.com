...
$rasPackage = $mydb->getArray('id,title,duration,show_cost,cost,cost_npr','tbl_package','urlcode="'.$packagecode.'"');

if($rasPackage['show_cost']=="")
{
    ...
    <h2>Submit Inquiry Form</h1>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12 frmbdr">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="tripname" id="tripname" value="<?php echo $rasPackage['title'];?>" readonly>
                </div>
                <div class="form-group">
                    <label for="tripdays" id="lbltripdays">Trip Duration:</label>
                    <input type="text" class="form-control" name="tripdays" id="tripdays" value="<?php echo $rasPackage['duration'];?>" readonly>
                </div>
                <div class="form-group">
                    <label for="tripdays" id="lbltripdays">Trip Cost (<?php echo $currency;?>):</label>
                    <input type="text" class="form-control" name="tripcost" id="tripcost" value="<?php echo $cost*2;?>" readonly>
                </div>
                <div class="form-group">
                    <label for="groupsize" id="lblgroupsize">Group Size:</label>
                    <select class="form-control" id="groupsize"  value="" name="groupsize" onchange="calculateTripcost(this.value,'<?php echo $cost;?>')">
                        <?php for($i=2;$i<=30;$i++){?>
