    ...
    <h2>Submit Inquiry Form</h1>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12 frmbdr">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="tripname" id="tripname" value="<?php echo $rasPackage['title'];?>" >
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="tripcost" id="tripcost" value="" >
                </div>
                <div class="form-group">
                    <label for="groupsize" id="lblgroupsize">Group Size:</label>
                    <select class="form-control" id="groupsize"  value="" name="groupsize" onchange="calculateTripcost(this.value,'<?php $_POST['tripcost'];?>')">
                        <?php for($i=1;$i<=30;$i++){?>
